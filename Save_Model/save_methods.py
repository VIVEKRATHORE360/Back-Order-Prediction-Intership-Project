...
class Model_Operation:
    ...
    def save_model(self,model,filename):
        ...
        self.logger_object.log(self.file_object, 'Entered the save_model method of the Model_Operation class')
        try:
    ...
    def load_model(self,filename):
        ...
        self.logger_object.log(self.file_object, 'Entered the load_model method of the Model_Operation class')
        try:
    ...
    def find_correct_model_file(self,cluster_number):
        ...
        self.logger_object.log(self.file_object, 'Entered the find_correct_model_file method of the Model_Operation class')
        try:
