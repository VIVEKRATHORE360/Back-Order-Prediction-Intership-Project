...
class Model_Finder:
    ...
    def get_best_params_for_random_forest(self,train_x,train_y):
        ...
        try:
            ...
            self.logger_object.log(self.file_object,'Random Forest Classifier best params: '+str(self.grid.best_params_)+'. Exited the get_best_params_for_random_forest method of the Model_Finder class')
            ...
            self.logger_object.log(self.file_object,'Random Forest Classifier Parameter tuning  failed. Exited the get_best_params_for_random_forest method of the Model_Finder class')
            raise Exception()
    ...
    def get_best_model(self,train_x,train_y,test_x,test_y):
        ...
        try:
            ...
            if len(test_y.unique()) == 1:
                ...
                self.logger_object.log(self.file_object, 'Accuracy for XGBoost Model :' + str(self.xgboost_score))
                # Log AUC
            else:
            ...
            if len(test_y.unique()) == 1:
                ...
                self.logger_object.log(self.file_object, 'Accuracy for Random Forest Model :' + str(self.random_forest_score))
            else:
                self.random_forest_score = roc_auc_score(test_y, self.prediction_random_forest) # AUC for Random Forest
                self.logger_object.log(self.file_object, 'AUC for Random forest Model :' + str(self.random_forest_score))
