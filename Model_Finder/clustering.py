...
class KMeansClustering:
    ...
    def elbow_plot(self,data):
        ...
        try:
            ...
            plt.savefig('Data_Information/K-Means_Elbow.PNG') # saving the elbow plot locally
    ...
    def create_clusters(self,data,number_of_clusters):
        ...
        self.data=data
        self.cluster = number_of_clusters
        try:
            self.kmeans = KMeans(n_clusters=self.cluster, init='k-means++', random_state=42)
            self.y_kmeans=self.kmeans.fit_predict(self.data) #  divide data into clusters

            self.file_op = save_methods.Model_Operation(self.file_object,self.logger_object)
